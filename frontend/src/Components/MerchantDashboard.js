...
export default function MerchantDashboard() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8080/orderProj`, {
        params: {
      ...
      .then((response) => {
        ...
        if (companyAccountChecked)
          filterCol.push({ field: "company_account_number" });
  ...
  return (
    <>
      ...
      <h3 style={{ marginLeft: 22, marginTop: 12 }}>Merchant Dashboard</h3>
      <FormControl
        style={{
          display: "flex",
          alignItems: "center",
        ...
        <FormControl component="fieldset">
          <FormGroup aria-label="position" row>
            ...
            <FormControlLabel
              ...
              control={
                <Checkbox
                  checked={companyAccountChecked}
                  onChange={handleCompanyAccountChange}
                />
              }
            ...
            <FormControlLabel
              value="fee"
              control={
                <Checkbox checked={feeChecked} onChange={handleFeeChange} />
              }
      ...
      <FormControl>
        <div
          ...
          style={{ width: 1410, height: 480, marginLeft: 20, marginTop: 6 }}
        >
          <AgGridReact
            rowData={resData}
      ...
      <FormControl
        style={{ marginLeft: 20, minWidth: 150, marginTop: 10 }}
        size="small"
      >
        ...
        <Select
          ...
          onChange={(e) => {
            ...
            axios.delete(`http://localhost:8080/order/${e.target.value}`);
          }}
        >
          {menuItems}
        </Select>
