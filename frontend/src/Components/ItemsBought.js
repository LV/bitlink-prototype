...
export default function ItemsBought() {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:8080/lineitemJoin`, {
            params: params
        }).then((response) => {
            const { data } = response;
            setRowData(data);
    ...
    return (
        <>
            ...
            <h3 style={{ marginLeft: 22 }}>Items Bought</h3>
            ...
            <div className='ag-theme-alpine' style={{ width: 1200, height: 500, marginLeft: 20, marginTop: 10 }}>
                <AgGridReact
                    rowData={rowData}
